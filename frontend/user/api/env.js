...
export const resetApiEnv = () => {
  if (hasStorage() && typeof uni.removeStorageSync === 'function') {
    uni.removeStorageSync(API_ENV_STORAGE_KEY)
  }

  return getApiConfig(DEFAULT_API_ENV)
}
