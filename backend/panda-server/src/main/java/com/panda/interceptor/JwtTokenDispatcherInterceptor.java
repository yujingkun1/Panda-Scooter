...
public class JwtTokenDispatcherInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) {
        ...
        try {
            ...
            Long dispatcherId = Long.valueOf(claims.get("dispatcherId").toString());
            BaseContext.setCurrentId(dispatcherId);
            return true;
        } catch (Exception e) {
